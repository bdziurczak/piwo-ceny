...
async def cheapest_beer():
    ...
    scores = [(x, beer_score(x["cut price"], x["terms"])) for x in beers_on_discount if "cut price" in x and "terms" in x]
